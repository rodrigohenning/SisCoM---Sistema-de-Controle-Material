    ...
    <body>
        ...
        <div id="wrapper">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                           ...
                           <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-barcode"></i><b> Dashboard > Categoria <?php if(isset($_GET['id'])){ echo " > Editar";} ?></b>
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                       ...
                       if(empty($_GET['id'])){
                        ...
                        <button type='button' class="btn btn-success btn-lg" data-toggle="modal" data-target=".bs-example-modal-lg" ><i class='fa fa-plus'> Adicionar Categoria </i></button>   
                        <br>
                        <br>
                    </div>
                    <!-- /.col-lg-12 -->
                                ...
                                <div class="dataTable_wrapper">
                                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            ...
                                            $rs = $conexao->query("SELECT  id_categoria, nome FROM categoria");
                                            ...
                                            while ($row = $rs->fetch(PDO::FETCH_ASSOC)) {
                                                ...
                                                echo "<td ><a href='?id=".$row["id_categoria"]."'><button type='button' class='btn btn-primary'><i class='fa fa-pencil'></i></button></a></td>";
                                                echo "</tr>";
                                            }                                          
            ...
            if(isset($_GET['id'])){
                ...
                $id=($_GET['id']);
                include("../include/conexao.php");
                $rs = $conexao->query("SELECT  id_categoria, nome FROM categoria WHERE id_categoria='$id'");
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="panel panel-danger">
                            ...
                            <div class="panel-body">
                                <div class="dataTable_wrapper">
                                    <form class="form-horizontal" role="form"  method="post" action="controle/funcategoria.php" >
                                        <!-- Text input-->
                                        <div class="form-group">
                                          <label class="col-md-3 control-label" for="textinput">Código Categoria:</label>  
                                          <div class="col-md-2">
                                              <input value='<?=$id?>' id="textinput" name="id" placeholder="Nome Completo" class="form-control input-md" required="" type="text" readonly="readonly">
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-md-5">
                                              <input value='<?=$pdescricao?>' id="textinput" name="categoria" placeholder="Nome Completo" class="form-control input-md" required="" type="text">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-md-8">
                                            <a href='categorias.php'><button type='button' class="btn btn-danger"><i class='fa fa-reply'> Voltar</i></button></a> 
                                            <button id="button1id" name="button1id" class="btn btn-success">Atualizar Categoria</button>                                    
                                        </div>
                                    </div>                   
                                </form>
                            </div>
     ...
     <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="exampleModalLabel"> <i class='fa fa-archive'></i> Cadastro de Categoria</h4>
        </div>
        <div class="modal-body">
          <form class="form-horizontal"  method="post" action="controle/funcategoria.php" >
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <input id="textinput" name="desccat" placeholder="Descrição" class="form-control input-md" required="" type="text">
